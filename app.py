...
def main():
    ...
    with tab1:
        ...
        if st.session_state.step == 0:
            ...
            st.markdown("<p style='text-align: center; font-size: 1.2rem;'><b>¡Bienvenido!</b> Empecemos a encontrar tu perfume ideal en 3 sencillos pasos</p>", unsafe_allow_html=True)
